...
/**
 * Splits mentions and tweets in tweets recieved from twitter4j
 */
public class MentionSplitBolt extends BaseRichBolt {
    ...
    public MentionSplitBolt(Set<String> languages, Set<String> hashtags, Set<String> mentions) {
